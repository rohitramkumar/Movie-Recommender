...
def process_filtering_request(req):
    ...
    final_discovery_url = final_discovery_url + client.encode_url_key_value(('with_genres', genre_ids))
    final_discovery_url = final_discovery_url + client.encode_url_key_value(('with_people', cast_ids))
    final_discovery_url = final_discovery_url + client.encode_url_key_value(('certification_country', 'US'))
    final_discovery_url = final_discovery_url + client.encode_url_key_value(('certification', user_specified_rating))
