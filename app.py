...
def processRequest(req):
    ...
    userSpecifiedGenres = req.get('result').get('contexts').get('parameters').get('genre')
    ...
    userSpecifiedCast = req.get('result').get('contexts').get('parameters').get('cast')
    ...
    userSpecifiedRating = req.get('result').get('contexts').get('parameters').get('rating')
